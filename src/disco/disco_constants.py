...
# IDs
# Menu bar ids
ID_TEMPLATE_MODE = wx.NewId()

SIDE_PANEL_WIDTH = 200
SIDE_PANEL_PADDING = 5
ROW_INDEX_COLUMN_WIDTH = 80
COLUMN_COUNT = 3

PROPERTY_NAME_COLUMN_INDEX = 0
DATA_TYPE_COLUMN_INDEX = 1
VALUE_COLUMN_INDEX = 2
PACKAGE_NAME_COLUMN_INDEX = 2
BUFFER_NAME_COLUMN_INDEX = 2
