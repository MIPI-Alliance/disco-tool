...
class TemplatePropertiesPanel(panel_base.PanelBase):
    ...
    def __init__(self, parent):
        ...
        self.props_grid.CreateGrid(0, 7)

        # sets the initial sizes for the property grid columns
        column_size = (w - app_constants.ROW_INDEX_COLUMN_WIDTH) / 7
        ...
        self.props_grid.SetColSize(3, column_size)
        self.props_grid.SetColSize(4, column_size)
        self.props_grid.SetColSize(5, column_size)
        self.props_grid.SetColSize(6, column_size)

        self.props_grid.SetColLabelValue(0, "Property Name")
        self.props_grid.SetColLabelValue(1, "Data Type")
        self.props_grid.SetColLabelValue(2, "Required")
        self.props_grid.SetColLabelValue(3, "Description")
        self.props_grid.SetColLabelValue(4, "OEMModified")
        self.props_grid.SetColLabelValue(5, "Default")
        self.props_grid.SetColLabelValue(6, "DependantPackages")
    ...
    def edit_column_index(self):
        return app_constants.VALUE_COLUMN_INDEX
